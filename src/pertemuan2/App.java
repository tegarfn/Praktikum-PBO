...
public class App {
    ...
    static void lihat() throws IOException {
        if (list.isEmpty()) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                System.out.print(list.get(i).nim + "\t");
                System.out.print(list.get(i).ipk + "\t");
            }
        }
    }
    ...
    static void ubah() throws IOException {
        ...
        System.out.print("Masukkan Nama : ");
        list.get(select).nama = input.readLine();
        System.out.print("Masukkan NIM : ");
        list.get(select).nim = Integer.parseInt(input.readLine());
        System.out.print("Masukkan IPK : ");
        list.get(select).ipk = Float.parseFloat(input.readLine());
